...
/**
 * \mainpage JUMP Framework
 <b>JUMP Framework</b> is a collection of classes in Objective-C to perform a series of tasks 
 on iOS or Mac OS applications. From Network libraries until User Interface libraries. 
 The framework have classes to accomplish day by day taks until very complex applications.
 <p>
 <h1>JUMP Framework Modules</h1>
